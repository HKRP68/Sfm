...
create table if not exists school_settings (
  ...
  receipt_prefix text default 'STAF',
...
create table if not exists fee_structures (
  ...
  monthly_tuition_fee numeric default 0,
  ...
  fine_default numeric default 0,
  due_day int default 10,
  created_at timestamptz default now(),
  updated_at timestamptz default now()
);

create table if not exists student_fee_settings (
  id uuid primary key default uuid_generate_v4(),
  student_id uuid references students(id),
  session_id uuid references academic_sessions(id),
  custom_monthly_tuition numeric default 0,
  discount_amount numeric default 0,
  scholarship_amount numeric default 0,
  transport_fee numeric default 0,
  old_balance numeric default 0,
  exam_fee_override numeric default 0,
  computer_fee_override numeric default 0,
  annual_fee_override numeric default 0,
  fine numeric default 0,
  special_concession numeric default 0,
  notes text,
  created_at timestamptz default now(),
  updated_at timestamptz default now()
);
...
create table if not exists student_monthly_ledgers (
  id uuid primary key default uuid_generate_v4(),
  student_id uuid references students(id),
  session_id uuid references academic_sessions(id),
  month_id uuid references fee_months(id),
...
alter table student_fee_settings enable row level security;
...
insert into classes(class_name,section,display_order) values
('PG','A',1),('LKG','A',2),('UKG','A',3),('Class 1','A',4),('Class 2','A',5),('Class 3','A',6),('Class 4','A',7),('Class 5','A',8),('Class 6','A',9),('Class 7','A',10),('Class 8','A',11)
...
create or replace view pending_fee_students as
select * from student_due_summary where pending > 0;
